        ...
        <header class="header">
            ...
            <div class="main-link">
                <ul class="items">
                    <li>
                        <nuxt-link to="#">
                            <svg viewBox="0 0 28 28" class="b6ax4al1 m4pnbp5e somyomsx ahndzqod p9vk499z" fill="#727478"
                                height="28" width="28">
                                <path
                    ...
                    <li>
                        <nuxt-link to="#">
                            <svg viewBox="0 0 28 28" class="b6ax4al1 m4pnbp5e somyomsx ahndzqod gnhxmgs4" fill="#727478"
                                height="28" width="28">
                                <path
            ...
            <div class="right-link">
                <ul class="right-nav-links">
                    <li class="item">
                        <nuxt-link to="#">
                            <svg fill="#050505" viewBox="0 0 44 44" width="20" height="20"
                    ...
                    <li class="item">
                        <nuxt-link to="#">
                            <svg viewBox="0 0 28 28" alt="" class="b6ax4al1 m4pnbp5e somyomsx ahndzqod g8r5yzqk"
                                fill="#050505" height="20" width="20">
                                <path
                    ...
                    <li class="item">
                        <nuxt-link to="#">
                            <svg viewBox="0 0 28 28" alt="" class="b6ax4al1 m4pnbp5e  ahndzqod g8r5yzqk" fill="#050505"
                                height="20" width="20">
                                <path
