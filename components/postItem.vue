  ...
  <div class="post">
    <div class="items">
      <div class="item" v-for="item in items" :key="item.id">
        ...
        <p>{{ item.postTitle }}</p>
        <img class="post-image" :src="item.postUrl" alt="" />
        <div class="react-btn">
...
.post {
  margin: 1rem 0;
  .item {
    border: 1px solid rgba(20, 17, 17, 0.2);
    background: #fff;
    border-radius: 10px;
  ...
  .react-btn {
    ...
    padding: 0.5rem 0;
    margin: 0.5rem;
    border-top: 1px solid rgba(20, 17, 17, 0.3);
    border-bottom: 1px solid rgba(20, 17, 17, 0.3);
    button {
      display: flex;
      align-items: center;
      gap: 0.5rem;
